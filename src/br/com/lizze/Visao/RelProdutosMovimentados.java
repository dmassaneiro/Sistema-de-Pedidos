 ...
 * @author Laydi
 */
public class RelProdutosMovimentados extends javax.swing.JFrame {

    /**
     * Creates new form RelProdutosMovimentados
     */
    public RelProdutosMovimentados() {
        initComponents();
    ...
    private void jButtonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOkActionPerformed
        ...
        String query = "SELECT venda_has_produtos.produtos_id,produtos.nome ,sum(quantidade) as Qtd" 
                ...
                +"where venda_has_produtos.produtos_id >= 0 and  venda.data between '" + dataInicial + "' and '" + dataFinal + "'"
        ...
        JasperPrint jp = null;
        try {
            jp = JasperFillManager.fillReport("C:\\Sys Feira Versao 1.0\\src\\ireport\\relProdutos.jasper", parameters, con);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelProdutosMovimentados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelProdutosMovimentados().setVisible(true);
            }
        });
    }
