 ...
 */
public class ConsultaVendedora extends javax.swing.JDialog {

    PreencherJbTableGenerico preencher = new PreencherJbTableGenerico();
    Vendedor vendedor = new Vendedor();

    public ConsultaVendedora(java.awt.Frame parent, boolean modal, Vendedor vend) {
        super(parent, modal);
        initComponents();
        tblProdutos();
    ...
    private void jTConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTConsultaMouseClicked
        if (evt.getClickCount() == 2) {
            vendedor.setId(Integer.parseInt(jTConsulta.getValueAt(jTConsulta.getSelectedRow(), 0).toString()));
            vendedor.setNome(jTConsulta.getValueAt(jTConsulta.getSelectedRow(), 1).toString());
            dispose();
        } else {
            vendedor.setId(Integer.parseInt(jTConsulta.getValueAt(jTConsulta.getSelectedRow(), 0).toString()));
            vendedor.setNome(jTConsulta.getValueAt(jTConsulta.getSelectedRow(), 1).toString());
    ...
    private void jTFPesuisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFPesuisaKeyReleased
      ...
      //  pesquisaUsuarios(jBtPesquisa.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaVendedora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
